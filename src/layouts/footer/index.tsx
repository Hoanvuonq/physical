...
const SOCIAL_LINKS = [
  {
    Icon: null,
    href: "https://www.tiktok.com/@thanhtam371991",
    label: "TikTok",
    type: "tiktok",
  },
  { Icon: Instagram, href: "#about", label: "Instagram" },
  { Icon: Linkedin, href: "#services", label: "LinkedIn" },
  {
    Icon: Facebook,
            ...
            <div className="w-full">
              ...
              <div className="flex flex-col gap-4">
                ...
                <Button
                  label=" Đăng Ký Ngay"
                  variant="primary"
                  className="py-3 px-8 !shadow-none"
                />
              </div>
            </div>
          </div>
